        ...
        for i, order in enumerate(orders, start=1):
            if order.partner_id:
                buyer = {
                    ...
                    'address': {
                        'street': order.partner_id.street[:60] or 'N/A',  # minimum 1 character required
                        'postal_code': order.partner_id.zip[:10] or 'N/A',  # minimum 1 character required
